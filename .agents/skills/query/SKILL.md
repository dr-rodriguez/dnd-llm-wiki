...
2. **Synthesize Answer:** Formulate a comprehensive answer using *only* the information found in the wiki and its sources. Cite the specific wiki pages (and sources if used).
